...
--
-- Hôte : 127.0.0.1
-- Généré le : dim. 06 oct. 2024 à 09:57
...
--
-- Base de données : `loulou_ecommerce`
--
...
CREATE TABLE `products` (
  ...
  `type` enum('tshirt','figurine','autre') NOT NULL,
...
--
ALTER TABLE `blog_comments`
  ADD CONSTRAINT `blog_comments_ibfk_1` FOREIGN KEY (`article_id`) REFERENCES `blog_articles` (`id`) ON DELETE CASCADE,
